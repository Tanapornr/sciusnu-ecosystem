...
```mermaid
flowchart TD
  A["เข้าสู่ระบบ<br/>เจ้าหน้าที่คณะวิทยาศาสตร์"] --> B["เลือกบทเรียน<br/>AI หรือ 5ส"]
  B --> C["ทำ Pre-test<br/>วัดความรู้ก่อนเรียน"]
  C --> D["บันทึกคะแนน Pre-test<br/>ลง Google Sheet"]
  D --> E["ดูวิดีโอเนื้อหา<br/>ระบบป้องกันการเลื่อนข้าม"]
  E --> F{"ดูวิดีโอจบหรือไม่"}
  F -- "ยังไม่จบ" --> E
  F -- "จบแล้ว" --> G["ปลดล็อก Post-test"]
  G --> H["ทำ Post-test<br/>วัดผลหลังเรียน"]
  H --> I["บันทึกคะแนนและความก้าวหน้า<br/>ลง Google Sheet"]
  I --> J{"จบครบหมวดและคะแนนเฉลี่ย<br/>Post-test ตั้งแต่ 80% หรือไม่"}
  J -- "ผ่านเกณฑ์" --> K["รับเกียรติบัตร<br/>AI หรือ 5ส"]
  J -- "ยังไม่ผ่าน/ยังไม่ครบ" --> L["เรียนบทถัดไปหรือทบทวน"]
  K --> M["ดูประวัติการเรียน<br/>รายการโปรด และกิจกรรม"]
  L --> M
  M --> N["Lifelong Learning Extension<br/>เพิ่มบทเรียนใหม่และพัฒนาต่อเนื่อง"]
```
